        ...
        <div class="sub-cont">
            <div class="img">
                ...
                <div class="img__btn" @click="goLogin">
                    <span class="m--in">Go Login</span>
                </div>
            </div>
            <div class="form sign-up">
                <h2>Media Sharing Platform Register</h2>
                <label>
                    <span>UserName</span>
                ...
                <el-button type="warning" class="submit" :loading="loading" @click="doRegister" round>Registration</el-button>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            checkRegisterForm() {
                if (!panUtil.checkUsername(this.registerForm.username)) {
                    this.$message.error('请输入4-16位只包含数字和字母的用户名')
                    return false
                }
