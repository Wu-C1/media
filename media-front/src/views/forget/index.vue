    ...
    <div class="content">
        <div class="steps-content">
            <el-steps :active="currentStep" direction="vertical" finish-status="success"
                ...
                <el-step title="Verify security answer"></el-step>
                <el-step title="Change password"></el-step>
            </el-steps>
        </div>
        <div class="form" v-if="currentStep === 0">
            <h2>Media Sharing Platform Verify Username</h2>
        ...
        <div class="form" v-if="currentStep === 1">
            <h2>Media Sharing Platform Verify security answer</h2>
            <div class="forget-form-content">
                <div class="forget-form-item">
                    <label>
                        <span>您的密保问题为</span>
            ...
            <el-button type="warning" class="submit" :loading="loading" @click="goStepThree" round>Next Step</el-button>
            <div class="login-link-content">
                <el-link type="primary" @click="goLogin">Go LogIn</el-link>
            </div>
        </div>
        <div class="form" v-if="currentStep === 2">
            <h2>Media Sharing Platform 重置密码</h2>
            <div class="forget-form-content">
                <div class="forget-form-item">
                    <label>
                        <span>新密码</span>
        ...
        methods: {
            ...
            checkPassword() {
                if (!panUtil.checkPassword(this.newPassword)) {
                    this.$message.error('请输入4-16位的密码')
                    return false
                }
