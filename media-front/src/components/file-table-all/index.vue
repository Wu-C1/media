    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions({
                ...
                reloadFileList: 'file/loadFileListAll'
            }),
              ...
              console.log(row)
                ...
                switch (row.fileType) {
                    ...
                    case 6:
                        ...
                        break
                    case 7:
                        this.$message.info('Cannot preview, click on the right side to download')
                        break
                    case 8:
                        _this.showMusic(row)
                        break
            ...
            showImg(row) {
                ...
                for (let i = 0, iLength = this.fileListAll.length; i < iLength; ++i) {
                    if (this.fileListAll[i].fileType === 7) {
                      console.log(this.fileListAll[i].fileId)
                      // console.log(row.fileId)
                        this.imgUrl.push(panUtil.getPreviewUrl(this.fileListAll[i].fileId))
                        if (this.fileListAll[i].fileId === row.fileId) {
                            this.imgIndex = i-1
                        }
                    }
                }
        ...
        computed: {
            ...mapGetters(['parentId', 'fileTypes', 'fileListAll', 'searchFlag', 'tableLoading'])
        },
        mounted() {
