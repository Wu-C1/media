package com.rubin.rpan.services.modules.user.service.impl;
...
import com.rubin.rpan.util.PasswordUtil;
...
import com.rubin.rpan.services.modules.share.vo.ShareUserInfoVO;
import com.rubin.rpan.services.modules.user.constant.UserConstant;
import com.rubin.rpan.services.modules.user.dao.RPanUserMapper;
import com.rubin.rpan.services.modules.user.entity.RPanUser;
...
public class UserServiceImpl implements IUserService {
    ...
    private String generateAndSaveToken(RPanUser rPanUser) {
        ...
        cacheManager.put(CommonConstant.USER_LOGIN_PREFIX + rPanUser.getUserId(), token, CommonConstant.ONE_DAY_LONG);
        return token;
    }
    ...
    private String generateAndSaveCheckAnswerToken(String username) {
        ...
        cacheManager.put(UserConstant.USER_FORGET_PREFIX + username, token, CommonConstant.FIVE_MINUTES_LONG);
        return token;
    }
    ...
    private void checkResetPasswordToken(String username, String inputToken) {
        Object token = cacheManager.get(UserConstant.USER_FORGET_PREFIX + username);
