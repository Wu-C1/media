...
public class FileController {
    ...
    @NeedLogin
    public R<List<RPanUserFileVO>> listAlls(@NotNull(message = "父id不能为空") @RequestParam(value = "parentId", required = false) Long parentId,
                                        @RequestParam(name = "fileTypes", required = false, defaultValue = "-1") String fileTypes) {
        return R.data(iUserFileService.listAlls(parentId, fileTypes, UserIdUtil.get()));
    }
    ...
    @ApiOperation(
            ...
            notes = "This interface provides the function of uploading flyer files",
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE
    )
     ...
     */
    @ApiOperation(
            value = "Upload shards and check uploaded shards",
            notes = "This interface provides the function of sharding upload and checking uploaded shards",
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE
    )
    ...
    /**
     * Splitting and uploading files
     *
     * @param fileChunkUploadPO
     * @return
     */
    @ApiOperation(
            value = "Splitting and uploading files",
            notes = "This interface provides the function of sharding and uploading files",
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE
    )
     ...
     */
    @ApiOperation(
            value = "Merge file shards",
            notes = "This interface provides the function of merging file shards",
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE
    )
     ...
     */
    @ApiOperation(
            value = "Transfer files in seconds",
            notes = "This interface provides the function of transferring files in seconds. After the file generates a unique identifier, it is uploaded and the physical upload is determined based on the returned result",
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE,
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE
    )
    ...
    public R secUpload(@Validated @RequestBody FileSecUploadPO fileSecUploadPO) {
        ...
        return R.fail("The unique identifier of the file does not exist. Please perform a physical upload");
    }
