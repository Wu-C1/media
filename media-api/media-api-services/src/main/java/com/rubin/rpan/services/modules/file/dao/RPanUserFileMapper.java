...
import com.rubin.rpan.services.modules.file.vo.RPanUserFileSearchVO;
...
public interface RPanUserFileMapper {
    ...
    List<RPanUserFileVO> selectRPanUserFileVOListByUserIdAndFileTypeAndParentIdAndDelFlagAll(@Param("userId") Long userId,
                                                                                          @Param("fileTypeArray") List<Integer> fileTypeArray,
                                                                                          @Param("parentId") Long parentId,
                                                                                          @Param("delFlag") Integer delFlag);
